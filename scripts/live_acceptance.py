...
PRODUCTION_PIPELINE_VERSION: Final = "production-pipeline-1.12.0"
NESTING_ALGORITHM_VERSION: Final = "deterministic-bottom-left-v2"
...
def run_acceptance(arguments: argparse.Namespace) -> dict[str, object]:
    ...
    corrected = mapping(
        nordic.json(
            "POST",
            "/v1/designs/autofix",
            payload=overloaded_spec | {"reinforcement_mode": "auto"},
        ),
